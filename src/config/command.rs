...
pub const COMMANDS: &[Command] = &[
    ...
    Command {
        name: "wa",
        aliases: &["wall", "write-all"],
        description: "save all buffers",
        args: Args::None,
        kind: Kind::Direct(DirectKind::SaveAll),
    },
    Command {
        name: "wa!",
        aliases: &["wall!", "write-all!"],
        description: "save all, overwriting disk drift",
        args: Args::None,
        kind: Kind::Direct(DirectKind::SaveAllForce),
    },
    Command {
        name: "wqa",
        aliases: &["xa", "xall", "wqall"],
        description: "save all & quit",
        args: Args::None,
        kind: Kind::Direct(DirectKind::SaveAllAndQuit),
    },
    Command {
        name: "wqa!",
        aliases: &["xa!", "wqall!"],
        description: "save all (overwriting drift) & quit",
        args: Args::None,
        kind: Kind::Direct(DirectKind::SaveAllAndQuitForce),
    },
    Command {
        name: "e",
        aliases: &["edit"],
